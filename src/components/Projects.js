...
// import img from '../images/projects/project-1.jpeg'; 
// import img2 from '../images//projects/project-2.jpeg';
// import img3 from '../images/projects/project-3.jpeg';
// import img4 from '../images/projects/project-4.jpeg';
// import { projects } from '../constants/const';

// const Projects = () => {

//     return (
//         <div id="projects" className="bg-gray-100 py-6" >
//             <section data-aos="zoom-in-down">
//                     <div className="my-4 py-4">
//                         <h2 className="my-2 text-center text-3xl text-secondary uppercase font-bold">Our Recent Projects</h2>
                        
//                         <div className='flex justify-center'>
//                             <div className='w-24 border-b-4 border-secondary'></div>
//                         </div>
//                         <h2 className="mt-4 mx-12 text-center text-xl lg:text-2xl font-semibold text-blue-900">Discover the exceptional properties we’ve managed and the outstanding results we’ve delivered for our clients.</h2>
//                     </div>
...
const ProjectCard = ({ img, title, location, description }) => {
  return (
    <div className="bg-white transition-all ease-in-out duration-400 overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
      <div className="m-2 text-center text-sm">
        <img
          ...
          src={img}
        />
        <h2 className="font-semibold my-4 text-2xl text-center text-secondary">
          {title}
        </h2>
        <p className="text-md font-medium">
          {title} is strategically located in{" "}
          <span className="text-lg text-primary">{location}</span> and designed
          to accommodate a large number of workers comfortably. {description}
        </p>
      </div>
    </div>
  );
...
const Projects = () => {
  return (
    <div className="px-12 " data-aos="fade-down" data-aos-delay="600" id="projects" >
         <div className="my-4 py-4 ">
                        <h2 className="my-2 text-center text-3xl text-secondary uppercase font-bold">Our Recent Projects</h2>
